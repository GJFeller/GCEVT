                ...
                d3Service.d3().then(function (d3) {
                    ...
                    scope.render = function (data) {
                        ...
                        var domainByVariable = {},
                            variables = d3.keys(data[0]).filter(function (d) { return d !== "name" }),
                            n = variables.length;
                        ...
                        variables.forEach(function (variable) {
                            domainByVariable[variable] = d3.extent(data, function (d) { return d[variable]; })
                        });
                        ...
                        function plot(p) {
                            ...
                            .enter().append("circle")
                                ...
                                .attr("r", 4)
                                .style("fill", function(d) { return d3.rgb(0,0,255);/*color(d.species);*/ });
